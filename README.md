...
```
cd existing_repo
git remote add origin https://gitlab.com/kerminefts/yirans-calendar.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/kerminefts/yirans-calendar/-/settings/integrations)
